...
class Store {
  ...
  String get addressText =>
      '${address.street}, ${address.number}${address.complement.isNotEmpty
          ? ' - ${address.complement}'
          : ''} - '
  ...
  void updateStatus(){
    ...
    final weekDay = DateTime.now().weekday; //pegar o dia da semana de 1 ate 7
    ...
    final now = TimeOfDay.now(); //horário atual;
